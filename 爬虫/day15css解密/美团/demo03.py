...
#  在请求头中，得到请求信息
url = 'https://sz.meituan.com/meishi/api/poi/getPoiList'
...
for page in range(1,6):
    ...
    #  在请求头中加入refer 信息
    headers_1['Referer']='https://sz.meituan.com/meishi/pn%s/'%(page)
    #print(headers_1)
    params = {
        'cityName': '深圳',
        'cateId': '0',
        ...
        'page': page,
        'userId': '357503284',
        'uuid': '62125f06e2e2433186b7.1604997170.1.0.0',
        'platform': 1,
        'partner': 126,
        'originUrl': 'https://sz.meituan.com/meishi/pn%s/'%(page),
        'riskLevel': 1,
        'optimusCode': 10,
    ...
    response = requests.get(url, params=params, headers=headers_1, verify=False)
